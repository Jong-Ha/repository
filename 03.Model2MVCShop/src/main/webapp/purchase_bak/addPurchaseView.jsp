...
function fncAddPurchase() {
	...
	$('#detailForm').attr('method','post').attr('action','/purchase/addPurchase').submit();
}
$(function(){
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		<td width="104" class="ct_write">수량
			<img src="/images/ct_icon_red.gif" width="3" height="3" align="absmiddle"/>
		</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="amount" 	class="ct_input_g" 
						style="width: 100px; height: 19px" maxLength="20" value="${ amount }" /> 개
						(최대 : ${ product.amount }개)
			<input type="hidden" id="maxAmount" name="maxAmount" value="${ product.amount }"/>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
