...
<form name="cartPurchase" method="post" action="/cart/buyCart">
	...
	<tr>
		...
		<td background="/images/ct_ttl_img02.gif" width="100%" style="padding-left: 10px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="93%" class="ct_ttl01">구매정보 입력</td>
...
<input type="hidden" name="prodNo" value="${ i.prod.prodNo }" />
	...
	<tr>
		...
		<td width="200" class="ct_write01">
			...
			<img 	src="../images/ct_icon_date.gif" width="15" height="15"	
						onclick="show_calendar('document.cartPurchase.receiverDate', document.cartPurchase.receiverDate.value)"/>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
